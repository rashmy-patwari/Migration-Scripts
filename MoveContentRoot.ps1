...
New-UsingBlock (New-Object Sitecore.Data.BulkUpdateContext) {
    ...
    if($createSrcItem) {
        $copied = Move-Item -Path $global:sourceItemPath -Destination $global:destinationItemPath -Recurse -PassThru -Force
        ...
        foreach($child in $children) {
            $copiedChildren = $child | Move-Item -Destination $global:destinationItemPath -Recurse -PassThru -Force
